...
def predict_disease_from_symptom(symptom_list):
    ...
    symptoms = {'itching': 0, 'skin_rash': 0, 'nodal_skin_eruptions': 0, 'continuous_sneezing': 0,
                ...
                'blister': 0, 'red_sore_around_nose': 0,'haswath':0, 'yellow_crust_ooze': 0}
...
def getDiseaseInfo(keywords):
    ...
    if results:
        print(results)
        return results[0].get('body', '')  # Return body of the first result, or an empty string if 'body' key is not found
    else:
